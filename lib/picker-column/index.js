...
component_1.VantComponent({
    ...
    created: function () {
        var _this = this;
        var _a = this.data, defaultIndex = _a.defaultIndex, initialOptions = _a.initialOptions, valueKey = _a.valueKey;
        var options = initialOptions.map(function (item) {
            var type = typeof item;
            var isObj = item !== null && (type === 'object' || type === 'function');
